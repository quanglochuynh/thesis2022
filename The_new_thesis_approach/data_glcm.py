...
def batch_prepare(i):
    ...
    for j in range(1,121):
        ...
        res = np.concatenate([extractor.glcm_correlation, extractor.glcm_dissimilarity], axis=None)
    ...
    np.savez_compressed('D:/Thesis_data/mlp_data/glcm_test_1_' + classes_name[i], xtest = x_test, ytest = y_test)
    ...
    # np.savez_compressed('D:/Thesis_data/mlp_data/glcm_train_1_' + classes_name[i], xtrain = x_train, ytrain = y_train)
